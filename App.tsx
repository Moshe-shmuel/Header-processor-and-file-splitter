...
const App: React.FC = () => {
  ...
  const scrollToHeader = useCallback((headerHtml: string, occurrenceIndex: number) => {
    ...
    if (index !== -1) {
      // 1. קודם כל פוקוס והצבת סמן כדי שהדפדפן יסיים את פעולת הניווט האוטומטית שלו
      textarea.focus();
      ...
      // 2. גלילה בתוך requestAnimationFrame כדי להבטיח שהיא תקרה אחרי הפוקוס ולא תתבטל
